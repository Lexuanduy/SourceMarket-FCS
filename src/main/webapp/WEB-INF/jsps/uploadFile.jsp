...
<body>
	<div class="container">
		<div class="content">
			...
			<div class="valid-nameSourceCode"></div>
			...
			<div class="row" style="padding: 5px 130px;">
				<div class="col-sm-6">
					<select class="w3-select w3-border select-up-source border-input"
						...
						<option value="" disabled="" selected="">Select kind of
							source code</option>
						<option value="1" data-id="K001">App mobile</option>
						<option value="2" data-id="K002">Game</option>
						<option value="3" data-id="K003">Website</option>
					</select>
				</div>
				<div class="col-sm-6" style="border-radius: 10px !important;">
					<select class="w3-select w3-border select-up-source border-input"
						...
						<option value="1" data-id="C001">Java</option>
						<option value="2" data-id="C002">Javascript</option>
						<option value="2" data-id="C003">C#</option>
					</select>
				</div>
			</div>
			<div class="valid-select-kind-category"></div>
			<div class="w3-panel w3-border-bottom w3-border-green"></div>
			...
			<div class="valid-description"></div>
			<div class="name-input" style="margin-top: 5px;">
				<p>
			...
			<div class="w3-panel w3-border-bottom w3-border-green"></div>
			<div class="linkdemo-source">
				<div>
					<strong>5. Link demo source code starts https: // or http:
						// (if not empty).</strong>
				</div>
			</div>
			<div class="valid-linkdemo"></div>
			<div class="name-input" style="margin-top: 5px;">
				<p>
			...
			<div class="valid-fileSource-linkSource"></div>
			<div class="w3-panel w3-border-bottom w3-border-green"></div>
			<div>
				<label><strong>7. Upload avatar format .jpeg, .jpg,
						.png (<span style="color: #F00;">Obligatory and size &lt;
							2M</span>)
				</strong></label>
				<div class="valid-avatar"></div>
			...
			<div>
				...
				<div class="valid-imgDescription"></div>
